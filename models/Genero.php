...
class Genero extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(Pelicula::class, ['idpelicula' => 'fk_idpelicula'])->viaTable('pelicula_has_genero', ['fk_idgenero' => 'idcategoria']);
    }
    ...
    {
        return $this->hasMany(PeliculaHasGenero::class, ['fk_idgenero' => 'idcategoria']);
    }
